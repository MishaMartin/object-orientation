...
favoriteThings.show = 'Schitt\'s Creek';
...
const phone1 = new Phone('Apple', 'iPhone 12', 256, 'Red', 799)
const phone2 = new Phone('Samsung', 'Note', 256, 'Blue', 1200)
const phone3 = new Phone('Google', 'Pixel', 128, "Black", 724)
...
const myFirstVehicle = new Vehicle('5','red', 179000)
...
const myFirstMotorcycle = new Motorcycle(2, "Black", 20000, "Honda")
